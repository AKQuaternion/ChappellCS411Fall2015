...
//   AND
//   (2c) No node in the tree is repeated (and therefore the tree
//         has finite height).
...
// createBinaryTree
// Create & return a Binary Tree holding parse tree of an arithmetic
// expression.
// Pre: None.
// Post:
...
BinaryTree createBinaryTree()
{
    ...
    auto np8 = make_shared<BTNode>("14");
